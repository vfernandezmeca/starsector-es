...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "Patrulla de la Hegemonia");
		api.setFleetTagline(FleetSide.ENEMY, "Destacamento de portaaviones de Tri-Tachyon");
		
		// These show up as items in the bulleted list under 
		// "Objetivos tacticos" on the mission detail screen
		api.addBriefingItem("Derrotad a las fuerzas enemigas");
		api.addBriefingItem("Si persigues a los cazas enemigos en retirada, llegaras a su portaaviones");
		api.addBriefingItem("Sincronizad vuestro avance con el ritmo de los ataques de torpedos enemigos");
