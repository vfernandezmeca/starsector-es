...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "ISS Van Rijn y flota de rescate");
		api.setFleetTagline(FleetSide.ENEMY, "Fuerzas de la coalicion pirata de Kanta");
		
		// These show up as items in the bulleted list under 
		// "Objetivos tacticos" on the mission detail screen
		api.addBriefingItem("Derrotad a todas las fuerzas enemigas");
		//api.addBriefingItem("La ISS Van Rijn debe sobrevivir");
		api.addBriefingItem("Teneis puntos de mando muy limitados");
		api.addBriefingItem("Concentrad vuestras fuerzas superiores para derrotar al enemigo por separado");
