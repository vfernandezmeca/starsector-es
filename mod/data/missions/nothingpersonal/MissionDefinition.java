...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "ISS Athena al mando de una flota de prospeccion");
		api.setFleetTagline(FleetSide.ENEMY, "La HSS Phoenix y destacamentos de guardia de la instalacion de la Hegemonia");
		
		// These show up as items in the bulleted list under 
		// "Objetivos tacticos" on the mission detail screen
//		api.addBriefingItem("Al menos el 25 % de vuestras fuerzas deben escapar");
//		api.addBriefingItem("Las naves con orden de retirada escaparan por el borde superior del mapa");
		api.addBriefingItem("Derrotad a las fuerzas enemigas");
		api.addBriefingItem("La ISS Enki debe sobrevivir; transporta equipo cientifico irreemplazable");
		api.addBriefingItem("Destruid primero los naves de escolta enemigas y luego atacad el corazon de su flota.");
