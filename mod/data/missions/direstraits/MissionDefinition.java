...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "Flota de socorro de la Hegemonia con escolta mercenaria");
		api.setFleetTagline(FleetSide.ENEMY, "Fuerza de tarea de contencion de Tri-Tachyon");
		
		// These show up as items in the bulleted list under 
		// "Objetivos tacticos" on the mission detail screen
		api.addBriefingItem("El ISS Black Star debe sobrevivir");
		api.addBriefingItem("Al menos el 25 % de las fuerzas de la Hegemonia debe escapar");
		...
		api.addToFleet(FleetSide.ENEMY, "astral_Strike", FleetMemberType.SHIP, "TTS agosto", false);
