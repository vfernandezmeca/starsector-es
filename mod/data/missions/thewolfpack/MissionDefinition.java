...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "Incursores mercenarios");
		api.setFleetTagline(FleetSide.ENEMY, "Convoy de la Hegemonia con escolta");
		
		// These show up as items in the bulleted list under 
		// "Objetivos tacticos" on the mission detail screen
		api.addBriefingItem("El convoy de la Hegemonia intentara huir hacia la parte superior del mapa");
		api.addBriefingItem("Controlar las boyas de navegacion es critico para evitar una huida rapida");
		api.addBriefingItem("Ordenar una busqueda y destruccion en toda la flota hara que vuestras naves sean mas agresivas");
		api.addBriefingItem("Si ordena a sus naves eliminar un objetivo, se volveran mas agresivas");
//		api.addBriefingItem("Inutilice tantas naves enemigas como pueda");
//		api.addBriefingItem("El Deimos debe sobrevivir");
