...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "Grupo de fase Gamma III de Tri-Tachyon");
		api.setFleetTagline(FleetSide.ENEMY, "Patrulla especial de la Hegemonia contra incursiones");
		
		// These show up as items in the bulleted list under 
		// "Objetivos tacticos" on the mission detail screen
		api.addBriefingItem("Derrota a todas las fuerzas enemigas");
		api.addBriefingItem("Usa SRM Sabot para sobrecargar objetivos resistentes antes de rematarlos con torpedos Reaper");
		api.addBriefingItem("Recuerda: tu blindaje puede absorber impactos de misiles anticaas sin problemas");
