...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "Destacamento de reconocimiento de Tri-Tachyon y naves de suministro");
		api.setFleetTagline(FleetSide.ENEMY, "HSS Bismar");
		
		// These show up as items in the bulleted list under 
		// "Objetivos tacticos" on the mission detail screen
		api.addBriefingItem("Destruid la HSS Bismar");
		api.addBriefingItem("La TTS Chimera es un prototipo valioso y debe sobrevivir");
