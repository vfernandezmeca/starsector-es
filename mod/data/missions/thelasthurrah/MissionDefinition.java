...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "Armada mayasuriana con gran dotacion de cazas");
		api.setFleetTagline(FleetSide.ENEMY, "Flota de la Hegemonia bajo el mando del comodoro Jensulte");
		
		// These show up as items in the bulleted list under 
		// "Objetivos tacticos" on the mission detail screen
		api.addBriefingItem("Derrotad a todas las fuerzas enemigas");
		api.addBriefingItem("La MSS Garuda debe sobrevivir");
		api.addBriefingItem("Mantened la conciencia tactica y usad vuestra superior movilidad para elegir vuestras batallas.");
		api.addBriefingItem("Recordad: si os enfrentais a la nave insignia enemiga en un combate justo, perdereis.");
