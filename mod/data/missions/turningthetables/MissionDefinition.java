...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "ISS Hamatsu e ISS Black Star con escolta de drones");
		api.setFleetTagline(FleetSide.ENEMY, "Fuerzas de la Senda Ludica");
		
		// These show up as items in the bulleted list under 
		// "Objetivos tacticos" on the mission detail screen
		api.addBriefingItem("Derrote a todas las fuerzas enemigas");
		api.addBriefingItem("El ISS Black Star y el ISS Hamatsu deben sobrevivir");
		api.addBriefingItem("Mantengase junto al ISS Hamatsu (crucero aliado) para su seguridad");
