...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "Fuerza de ataque del ISS Black Star y la Senda Ludica");
		api.setFleetTagline(FleetSide.ENEMY, "PLS Praxis con escolta y aliados de Tri-Tachyon");
		
		// These show up as items in the bulleted list under 
		// "Objetivos tacticos" on the mission detail screen
		api.addBriefingItem("Distrae al buque insignia enemigo para permitir que tus bombarderos lo flanqueen");
