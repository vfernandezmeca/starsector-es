...
public class OmniShieldEmitter extends BaseHullMod {
	...
	public String getUnapplicableReason(ShipAPI ship) {
		if (ship == null || ship.getShield() == null) return "La nave no tiene escudos";
		
		if (ship.getShield().getType() == ShieldType.OMNI) { 
			return "La nave ya dispone de escudos omnidireccionales";
		}
		
		if (ship.getVariant().getHullMods().contains("frontemitter")) {
			return "Incompatible con la conversion de escudo - frontal";
		}
