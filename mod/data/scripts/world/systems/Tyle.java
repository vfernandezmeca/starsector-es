...
public class Tyle {
	...
	public void generate(SectorAPI sector) {
		...
		system.addAsteroidBelt(tyle_star, 60, 4350, 170, 200, 250, Terrain.ASTEROID_BELT, "Archipielago de Tyle");
...
/*			SectorEntityToken gate = system.addCustomEntity("wuya_gate", // unique id
					 "Portal de Wuya", // name - if null, defaultName from custom_entities.json will be used
					 "inactive_gate", // type of object, defined in custom_entities.json
					 null); // faction
			gate.setCircularOrbit(system.getEntityById("tyle"), 90+62, 4800, 260);*/
		
		// Wuya Jump
		JumpPointAPI jumpPoint1 = Global.getFactory().createJumpPoint("wuya_jump", "Salto de Wuya");
		...
		tyle_d.setCustomDescriptionId("planet_canaria");
			...
			// Canaria Relay
			SectorEntityToken canaria_relay = system.addCustomEntity("canaria_relay", "Rele de Canaria", "comm_relay", "persean");
		...
		/*JumpPointAPI jumpPoint2 = Global.getFactory().createJumpPoint("antillia_jump", "Punto de salto de Antillia");
