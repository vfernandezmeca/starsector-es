...
public class Duzahk {
	...
	public void addHyperspaceStation(final SectorAPI sector) {
		...
		final SectorEntityToken hyperstation = hyper.addCustomEntity("hyperstation_test", "Estacion de hiperespacio", "station_mining00", Factions.INDEPENDENT);
...
//		});
	...
	public void generate(SectorAPI sector) {
		...
		PlanetAPI duzahk1 = system.addPlanet("duzahk1", duzahk_star, "Tambien Mainyu", "gas_giant", 0, 230, 1550, 24);
		...
		system.addAsteroidBelt(duzahk_star, 50, 2400, 100, 30, 40, Terrain.ASTEROID_BELT, "Los Daevas");
		...
		//		 "Rele Druj", // name - if null, defaultName from custom_entities.json will be used
		...
		//JumpPointAPI jumpPoint = Global.getFactory().createJumpPoint("penelope_jump_point_alpha", "Salto en el sistema interior de Penelope's Star");
