...
public class Naraka {
	...
	public void generate(SectorAPI sector) {
		...
		system.addRingBand(naraka_star, "misc", "rings_dust0", 256f, 0, Color.white, 256f, 3300, 220f, Terrain.RING, "La Yamuna");
		...
		// Yamidutas : asteroids
		system.addAsteroidBelt(naraka_b, 60, 900, 170, 200, 250, Terrain.ASTEROID_BELT, "Los siervos");
		...
		JumpPointAPI jumpPoint1 = Global.getFactory().createJumpPoint("naraka_jump", "Punto de salto Naraka");
		jumpPoint1.setCircularOrbit( system.getEntityById("naraka"), 60 + 60, 4600, 140);
		jumpPoint1.setRelatedPlanet(naraka_c);
		system.addEntity(jumpPoint1);
		
		// Naraka Relay
		SectorEntityToken relay = system.addCustomEntity("naraka_relay", "Rele Naraka", "comm_relay", "hegemony");
