...
public class Askonia {
	...
	public void generate(SectorAPI sector) {
		...
		a1.setInteractionImage("illustrations", "sindria");
			...
			JumpPointAPI jumpPoint = Global.getFactory().createJumpPoint("askonia_jump_point_alpha", "Punto de salto de Sindria");
			...
			SectorEntityToken sindria_relay = system.addCustomEntity("sindria_relay", // unique id
					 "Rele de Sindria", // name - if null, defaultName from custom_entities.json will be used
		...
		system.addAsteroidBelt(star, 150, 3600, 170, 200, 250, Terrain.ASTEROID_BELT, "Rio de piedra");
	...
	// Salus system
		...
		a2.applySpecChanges();
			...
			system.addAsteroidBelt(a2, 50, 1100, 128, 40, 80, Terrain.ASTEROID_BELT, "Anillo de Opis");
			...
			SectorEntityToken opis_debris_cloud = system.addTerrain(Terrain.ASTEROID_FIELD,
				new AsteroidFieldParams(
					...
					"Nube de escombros de Askonia")); // null for default name
			...
			a2b.setInteractionImage("illustrations", "volturn");
				...
				SectorEntityToken salus_nav = system.addCustomEntity(null, "Boyas de navegacion de Salus", "nav_buoy", Factions.DIKTAT); 
			...
			system.addRingBand(a2, "misc", "rings_dust0", 256f, 1, Color.white, 256f, 1800, 110f, Terrain.RING, "Anillo de polvo");
			...
			system.addRingBand(a2, "misc", "rings_ice0", 256f, 1, Color.white, 256f, 2150, 90f, Terrain.RING, "Anillo de nubes");
		...
		// Nortia - Independent (Charterist) base - caught in Salus' L4
			...
			SectorEntityToken salusL4 = system.addTerrain(Terrain.ASTEROID_FIELD,
					new AsteroidFieldParams(
						...
						"Asteroides L4 de Salus")); // null for default name
			...
			SectorEntityToken salusL5 = system.addTerrain(Terrain.ASTEROID_FIELD,
					new AsteroidFieldParams(
						...
						4f, // min asteroid radius 
						16f, // max asteroid radius
						"Asteroides L5 de Salus")); // null for default name
			
			salusL4.setCircularOrbit(star, 230 + 60, 7500, 250);
			salusL5.setCircularOrbit(star, 230 - 60, 7500, 250);
			
			// Askonia Outer Jump (in Salus L5)
			JumpPointAPI jumpPoint2 = Global.getFactory().createJumpPoint("salus_jump", "Punto de salto L5 de Salus");
		...
		SectorEntityToken askonia_outer_array = system.addCustomEntity(null, "Estacion de escucha del Confin de Askonia", "sensor_array_makeshift", Factions.DIKTAT); 
...
//				 360f); // max spin (degrees/day)
		...
		SectorEntityToken station = system.addCustomEntity("diktat_cnc", "Mando y control", "station_side02", "sindrian_diktat");
