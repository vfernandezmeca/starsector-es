...
public class AlGebbar {
	...
	public void generate(SectorAPI sector) {
		...
		// Al Gebbar Jumppoint
		JumpPointAPI jumpPoint2 = Global.getFactory().createJumpPoint("algebbar_jump", "Punto de salto de Al Gebbar");
		...
		//SectorEntityToken ring = system.addTerrain(Terrain.RING, new RingParams(256 + 256, 3500, null, "El caos de Gebbar"));
		...
		PlanetAPI gebbar5 = system.addPlanet("gebbar5", algebbar_star, "Loutron", "cryovolcanic", 90, 120, 6400, 295);
			...
			SectorEntityToken abandoned_station = system.addCustomEntity("abandoned_station", "Ancla de un skyhook abandonado", "station_mining00", "neutral");
