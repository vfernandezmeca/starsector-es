...
public class Zagan {
	...
	public void generate(SectorAPI sector) {
		...
		system.addAsteroidBelt(zagan_star, 90, 3650, 500, 150, 300, Terrain.ASTEROID_BELT,  "Soplos de la perdicion");
		...
		mazalot_magfield.setCircularOrbit(mazalot, 0, 0, 100);
			...
			SectorEntityToken relay = system.addCustomEntity("mazalot_relay", // unique id
					 "Rele de Mazalot", // name - if null, defaultName from custom_entities.json will be used
			...
			SectorEntityToken gate = system.addCustomEntity("mazalot_gate", // unique id
					 "Portal de Mazalot", // name - if null, defaultName from custom_entities.json will be used
		...
		// Zagan jump-point
		JumpPointAPI jumpPoint2 = Global.getFactory().createJumpPoint("yesod_jump", "Punto de salto de Yesod");
