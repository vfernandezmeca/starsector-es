...
public class Samarra {
	...
	// Tigra Ring
		system.addAsteroidBelt(samarra_star, 100, 3000, 500, 100, 190, Terrain.ASTEROID_BELT, "Anillo de Tigra");
		...
		SectorEntityToken tigra_city = system.addCustomEntity("tigra_city", "Ciudad de Tigra", "station_side00", "hegemony");
	...
	// Eventide
		...
		samarra1.setInteractionImage("illustrations", "eventide");
			...
			SectorEntityToken eventide_mirror1 = system.addCustomEntity("eventide_mirror1", "Espejo estelar de Eventide Alpha", "stellar_mirror", "hegemony");
			SectorEntityToken eventide_mirror2 = system.addCustomEntity("eventide_mirror2", "Espejo estelar de Eventide Beta", "stellar_mirror", "hegemony");	
			SectorEntityToken eventide_mirror3 = system.addCustomEntity("eventide_mirror3", "Espejo estelar de Eventide Gamma", "stellar_mirror", "hegemony");
			SectorEntityToken eventide_mirror4 = system.addCustomEntity("eventide_mirror4", "Espejo estelar de Eventide Delta", "stellar_mirror", "hegemony");
			SectorEntityToken eventide_mirror5 = system.addCustomEntity("eventide_mirror5", "Espejo estelar de Eventide Epsilon", "stellar_mirror", "hegemony");
			...
			SectorEntityToken eventide_shade1 = system.addCustomEntity("eventide_mirror1", "Sombra estelar de Eventide Omega", "stellar_shade", "hegemony");
			SectorEntityToken eventide_shade2 = system.addCustomEntity("eventide_mirror3", "Sombra estelar de Eventide Psi", "stellar_shade", "hegemony");
			SectorEntityToken eventide_shade3 = system.addCustomEntity("eventide_mirror5", "Sombra estelar de Eventide Chi", "stellar_shade", "hegemony");
			...
			SectorEntityToken samarra_relay = system.addCustomEntity("samarra_relay", // unique id
					 "Rele de Samarra", // name - if null, defaultName from custom_entities.json will be used
					 "comm_relay", // type of object, defined in custom_entities.json
					 "hegemony"); // faction
			samarra_relay.setCircularOrbitPointingDown( system.getEntityById("samarra"), 30 - 60, 4000, 200);
	
			// Samarra Jump - L4 (ahead)
			JumpPointAPI jumpPoint = Global.getFactory().createJumpPoint("samarra_jump_point_alpha", "Punto de salto de Samarra");
	...
	// Typhon System
		...
		samarra2.setCustomDescriptionId("planet_typhon");
			...
			SectorEntityToken orthrus_relay = system.addCustomEntity("orthrus_relay", // unique id
					 "Rele Orthrus", // name - if null, defaultName from custom_entities.json will be used
					 "comm_relay", // type of object, defined in custom_entities.json
					 "independent"); // faction
			...
			SectorEntityToken typhonL4 = system.addTerrain(Terrain.ASTEROID_FIELD,
					new AsteroidFieldParams(
						...
						"Asteroides de Typhon L4")); // null for default name
			...
			SectorEntityToken typhonL5 = system.addTerrain(Terrain.ASTEROID_FIELD,
					new AsteroidFieldParams(
						...
						4f, // min asteroid radius 
						16f, // max asteroid radius
						"Asteroides de Typhon L5")); // null for default name
			...
			JumpPointAPI jumpPoint2 = Global.getFactory().createJumpPoint("samarra_jump_point_beta", "Punto de salto de Typhon");
