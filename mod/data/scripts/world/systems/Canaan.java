	...
	public void generate(SectorAPI sector) {
		...
		gilead.setInteractionImage("illustrations", "gilead");
			...
			SectorEntityToken relay = system.addCustomEntity("gilead_relay", // unique id
					 "Rele de Gilead", // name - if null, defaultName from custom_entities.json will be used
					 "comm_relay_makeshift", // type of object, defined in custom_entities.json
					 "luddic_church"); // faction
			relay.setCircularOrbitPointingDown(canaan_star, 60-60, 5000, 250);
			
			// L5
			JumpPointAPI jumpPoint1 = Global.getFactory().createJumpPoint("gilead_jump", "Punto de salto de Gilead");
		...
		SectorEntityToken gate1 = system.addCustomEntity("canaan_gate", // unique id
				 "Portal de Canaan", // name - if null, defaultName from custom_entities.json will be used
		...
		// Canaan Jumppoint
		/*
		JumpPointAPI jumpPoint2 = Global.getFactory().createJumpPoint("canaan_jump", "Punto de salto de Canaan");
