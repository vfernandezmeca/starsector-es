...
public class KumariKandam {
	...
	public void generate(SectorAPI sector) {
		...
		kumarikandam_b.setCustomDescriptionId("planet_kumari_aru");
			...
			// Beholder Station
			SectorEntityToken beholder_station = system.addCustomEntity("beholder_station", "Estacion Beholder", "station_side05", "luddic_church");
			...
			SectorEntityToken kumari_aruL4 = system.addTerrain(Terrain.ASTEROID_FIELD,
					new AsteroidFieldParams(
						...
						"Asteroides Kumari Aru L4")); // null for default name
			...
			SectorEntityToken kumari_aruL5 = system.addTerrain(Terrain.ASTEROID_FIELD,
					new AsteroidFieldParams(
						...
						4f, // min asteroid radius 
						16f, // max asteroid radius
						"Asteroides Kumari Aru L5")); // null for default name
		...
		chalcedon_loc.setCircularOrbitPointingDown(kumarikandam_star, 220-180, 4300, 180);
			...
			// Destroyed station
			SectorEntityToken abandoned_station1 = system.addCustomEntity("abandoned_spacedock", "Dique espacial abandonado", "station_side00", "neutral");
			...
			JumpPointAPI jumpPoint2 = Global.getFactory().createJumpPoint("kumarikandam_jump", "Puente de Rama");
		...
		system.addAsteroidBelt(kumarikandam_star, 150, 5900, 128, 200, 240, Terrain.ASTEROID_BELT, "El Mullam");
