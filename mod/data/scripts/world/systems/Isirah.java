...
public class Isirah {
	...
	public void generate(SectorAPI sector) {
		...
		JumpPointAPI jumpPoint2 = Global.getFactory().createJumpPoint("isirah_jump", "Punto de salto de Isirah");
		jumpPoint2.setCircularOrbit( system.getEntityById("isirah"), 120 + 60, 2700, 80);
		jumpPoint2.setRelatedPlanet(isirah_c);
		system.addEntity(jumpPoint2);
			
		// Utgarda Disk : "los suburbios" 
		...
		SectorEntityToken ring1 = system.addTerrain(Terrain.RING, new RingParams(900, 3500, null, "El muro de Utgarda"));
		...
		SectorEntityToken isirah_d1 = system.addTerrain(Terrain.ASTEROID_FIELD,
				new AsteroidFieldParams(
					...
					"Enjambre de acrecion de Corb")); // null for default name
		...
		// Vosud Disc : "el abuelo del invierno"
		...
		SectorEntityToken station3 = system.addCustomEntity("groombridge_habitat", "Habitat de Groombridge", "station_side00", "neutral");
