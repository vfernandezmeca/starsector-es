...
public class Westernesse {
	...
	public void generate(SectorAPI sector) {
		...
		//	SectorEntityToken fikenhildStation = system.addCustomEntity("fikenhild_station", "Puerto estelar de Horn", "station_midline1",  Factions.PERSEAN);
		...
		JumpPointAPI jumpPoint1 = Global.getFactory().createJumpPoint("westernesse_jump", "Punto de salto de Westernesse");
		...
		SectorEntityToken westernesse_relay = system.addCustomEntity("westernesse_relay", "Rele de Westernesse", "comm_relay", "persean");
