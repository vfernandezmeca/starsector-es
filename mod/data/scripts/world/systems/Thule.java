...
public class Thule {
	...
	public void generate(SectorAPI sector) {	
		...
		system.addAsteroidBelt(thule_star, 90, 3750, 500, 100, 120, Terrain.ASTEROID_BELT,  "El Ingwin");
		...
		system.addAsteroidBelt(thule_star, 90, 4550, 500, 290, 310, Terrain.ASTEROID_BELT,  "Banda de Hama");
		...
		//SectorEntityToken kazeronStation = system.addCustomEntity("kazeron_station", "Mando estelar de Kazeron", "station_midline2", Factions.PERSEAN);
		...
		//kazeronStation.setInteractionImage("illustrations", "orbital");
			...
			// Kazeron jump-point
			JumpPointAPI jumpPoint1 = Global.getFactory().createJumpPoint("thule_jump", "Punto de salto de Thule");
		...
		system.addAsteroidBelt(thule_star, 90, 5950, 500, 150, 300, Terrain.ASTEROID_BELT,  "Corona de Inged");
		...
		system.addAsteroidBelt(thule_star, 90, 7650, 500, 150, 300, Terrain.ASTEROID_BELT,  "Anillo de Garmund");
		...
		system.addRingBand(thule_star, "misc", "rings_ice0", 256f, 1, new Color(230,240,255,255), 256f, 7870, 395, null, null);
			...
			SectorEntityToken thule_pirate_station = system.addCustomEntity("thule_pirate_station",
					"Base de incursion de Thule", "station_pirate_type", "pirates");
		...
		morn.applySpecChanges();
			...
			SectorEntityToken nebula1 = system.addTerrain(Terrain.NEBULA, new BaseTiledTerrain.TileParams(
					...
					"terrain", "nebula", 4, 4, "Nube de Morn L5"));
			...
			SectorEntityToken nebula2 = system.addTerrain(Terrain.NEBULA, new BaseTiledTerrain.TileParams(
					...
					" x    ",
					6, 6, // size of the nebula grid, should match above string
					"terrain", "nebula", 4, 4, "Nube de Morn L4"));
