...
public class Aztlan {
	...
	public void generate(SectorAPI sector) {
		...
		system.addAsteroidBelt(aztlan_star, 150, 3100, 128, 60, 80, Terrain.ASTEROID_BELT, "El Ciltetl");
	...
	// Chicomoztoc & friends
		...
		aztlan2.setInteractionImage("illustrations", "urban03");
			...
			SectorEntityToken hegemonyStation = system.addCustomEntity("aztlan_starport", "Astropuerto de Aztlan", "station_lowtech2", "hegemony");
			...
			JumpPointAPI jumpPoint_aztlan = Global.getFactory().createJumpPoint("aztlan_jump_point_alpha", "Punto de salto del sistema interior de Aztlan");
	...
	// Tlalocan System
		...
		aztlan3.applySpecChanges();
			...
			SectorEntityToken coatl_station = system.addCustomEntity("coatl_station", "Bastion Coatl", "station_side02", "hegemony");
		...
		JumpPointAPI jumpPoint_aztlan2 = Global.getFactory().createJumpPoint("aztlan_jump_point_beta", "Punto de salto del sistema exterior de Aztlan");
