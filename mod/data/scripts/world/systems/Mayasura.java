...
public class Mayasura {
	...
	public void generate(SectorAPI sector) {
		...
		JumpPointAPI jumpPoint = Global.getFactory().createJumpPoint("mayasura_jump", "Punto de salto de Mayasura");
		...
		mayasura_d.setInteractionImage("illustrations", "mairaath");
			...
			SectorEntityToken mairaathStation1 = system.addCustomEntity("mairaath_abandoned_station1",
				"Astropolis abandonada", "station_side06", "neutral");
		...
		system.addAsteroidBelt(mayasura_star, 90, 4300, 200, 140, 180, Terrain.ASTEROID_BELT, "Los Danavas");
		system.addRingBand(mayasura_star, "misc", "rings_dust0", 256f, 0, Color.white, 256f, 4360, 160f);
			...
			SectorEntityToken pirateStation = system.addCustomEntity("mairaath_abandoned_station2",
					"Astropolis perdida", "station_side06", "pirates");
			...
			/*SectorEntityToken gate = system.addCustomEntity("mayasura_gate", // unique id
					 "Portal de Mayasura", // name - if null, defaultName from custom_entities.json will be used
		...
		system.addAsteroidBelt(mayasura_star, 120, 5130, 300, 200, 300, Terrain.ASTEROID_BELT, "El Daitya");
		...
		mayasura_e.applySpecChanges();
			...
			SectorEntityToken tritachStation = system.addCustomEntity("port_tse", "Estacion de la franquicia Port Tse", "station_side00", "tritachyon");
		...
		// Mayasura Relay
		SectorEntityToken mayasura_relay = system.addCustomEntity("mayasura_relay", "Rele de Mayasura", "comm_relay", "tritachyon");
		...
		system.addAsteroidBelt(mayasura_star, 150, 7500, 400, 370, 430, Terrain.ASTEROID_BELT, "Los Takshaka");
