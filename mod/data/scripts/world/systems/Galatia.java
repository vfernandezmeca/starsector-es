...
public class Galatia {
	...
	public void generate(SectorAPI sector) {
		...
		SectorEntityToken ancyraStation = system.addCustomEntity("ancyra_station", "Instalacion orbital de Ancyra", "station_side00", Factions.HEGEMONY);
		...
		SectorEntityToken relay = system.addCustomEntity("ancyra_relay", // unique id
				 "Rele de Ancyra", // name - if null, defaultName from custom_entities.json will be used
		...
		SectorEntityToken pontus = system.addPlanet("pontus", star, "Pontus", "gas_giant", 200, 300, 6200, 400);
			...
			SectorEntityToken galatiaAcademy = system.addCustomEntity("station_galatia_academy", "Estacion de la Academia de Galatia", "station_galatia", Factions.INDEPENDENT);
		...
		SectorEntityToken derinkuyuStation = system.addCustomEntity("derinkuyu_station", "Estacion minera Derinkuyu", "station_mining00", Factions.PIRATES);
		...
		JumpPointAPI inner = Global.getFactory().createJumpPoint("galatia_jump_point_alpha", "Punto de salto del sistema interior");
		...
		JumpPointAPI fringe = Global.getFactory().createJumpPoint("galatia_jump_point_fringe", "Punto de salto del Confin");
