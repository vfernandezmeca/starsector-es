		...
		*/
		...
		SectorEntityToken tia_field1 = system.addTerrain(Terrain.ASTEROID_FIELD,
				new AsteroidFieldParams(
					...
					"Cumulo de asteroides Tia-Ta'xet")); // null for default name
		
		tia_field1.setCircularOrbit(tia_star, 180, 4500, 250);
		
		
		// Abandoned shipyard /research station
			SectorEntityToken abandoned_station1 = system.addCustomEntity("abandoned_spacedock", "Estacion de investigacion abandonada", "station_side00", "neutral");
			...
			// "No es nada personal" battle debris :D
		...
		SectorEntityToken tia_field4 = system.addTerrain(Terrain.ASTEROID_FIELD,
				new AsteroidFieldParams(
					...
					4f, // min asteroid radius 
					16f, // max asteroid radius
					"Los Mosquitos")); // null for default name
		
		tia_field4.setCircularOrbit(tia_star, 180, 5700, 400);
		
		
		// Tia-Ta'xet Jumppoint
		JumpPointAPI jumpPoint2 = Global.getFactory().createJumpPoint("tia-taxet_jump", "Punto de salto Tia-Ta'xet");
