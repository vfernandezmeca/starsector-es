	...
	public void generate(SectorAPI sector) {
		...
		magec3a.setCustomDescriptionId("planet_tibicena");
			...
			SectorEntityToken achaman_station = system.addCustomEntity("achaman_enterprise_station", 
																		"Estacion de Achaman Enterprise",
																		"station_side04",
																		"tritachyon");
...
//		system.addRingBand(a2, "misc", "rings1", 256f, 1, Color.white, 256f, 1700, 110f);
		...
		//SectorEntityToken pirateStation = system.addOrbitalStation("kantas_den", star, 240, 4250, 160, "el Antro de Kanta", "pirates");
		SectorEntityToken pirateStation = system.addCustomEntity("kantas_den", "el Antro de Kanta", "station_side06", "pirates");
		...
		JumpPointAPI jumpPoint = Global.getFactory().createJumpPoint("maxios_jump_point", "Punto de salto de Maxios");
