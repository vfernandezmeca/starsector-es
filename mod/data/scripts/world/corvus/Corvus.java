...
//		PlanetAPI corvusXa = system.addPlanet("test1", star, "Anomalia Alfa", "lava_minor", 240, 120, 2500, 120);
//		PlanetAPI corvusXb = system.addPlanet("test2", star, "Anomalia Beta", "lava", 250, 120, 2100, 120);
	...
	// Asharu
		...
		SectorEntityToken neutralStation = system.addCustomEntity("corvus_abandoned_station",
				"Plataforma de terraformacion abandonada", "station_side06", "neutral");
...
//																300, 
//																30,
//																"Plataforma de terraformacion abandonada",
//																"neutral");
		
		
		// Asharu stellar shade - out of orbit, settled in one of Asharu's lagrangian points 
		SectorEntityToken asharu_shade = system.addCustomEntity("asharu_shade", "Sombra estelar de Asharu", "stellar_shade", "neutral");
	...
	// Jangala 
		...
		corvusII.applySpecChanges();
			...
			SectorEntityToken hegemonyStation = system.addCustomEntity("corvus_hegemony_station",
					"Estacion de Jangala", "station_jangala_type", "hegemony");
					// "Estacion de Jangala", "station_jangala_type", "hegemony");
			...
			SectorEntityToken relay = system.addCustomEntity("corvus_relay", // unique id
					 "Rele de Jangala", // name - if null, defaultName from custom_entities.json will be used
	...
	//		stable.setCircularOrbitPointingDown(system.getEntityById("corvus"), 245-60-30, 4500, 200);
			...
			JumpPointAPI jumpPoint = Global.getFactory().createJumpPoint("jangala_jump", "Punto de salto de Jangala");
		...
		SectorEntityToken gate = system.addCustomEntity("jangala_gate", // unique id
				 "Portal Corvus", // name - if null, defaultName from custom_entities.json will be used
				 "inactive_gate", // type of object, defined in custom_entities.json
				 null); // faction
		gate.setCircularOrbit(system.getEntityById("corvus"), 0, 6000, 350);

	// Not-yet-named Asteroids // Let's try "Nemo"
		system.addAsteroidBelt(star, 90, 5650, 500, 150, 300, Terrain.ASTEROID_BELT,  "Cinturon de Nemo");
	...
	// Barad system
		...
		barad_field.setCircularOrbit(corvusIII, 0, 0, 100);
			...
			SectorEntityToken pirateStation = system.addCustomEntity("corvus_pirate_station",
					"Deposito de extraccion de Garnir", "station_lowtech1", "pirates");
			...
			SectorEntityToken baradL4 = system.addTerrain(Terrain.ASTEROID_FIELD,
					new AsteroidFieldParams(
						...
						"Asteroides Barad L4")); // null for default name
			...
			SectorEntityToken baradL5 = system.addTerrain(Terrain.ASTEROID_FIELD,
					new AsteroidFieldParams(
						...
						4f, // min asteroid radius 
						16f, // max asteroid radius
						"Asteroides Barad L5")); // null for default name
		...
		*/ 
		...
		SectorEntityToken asteroidField = system.addTerrain(Terrain.ASTEROID_FIELD,
						new AsteroidFieldParams(
								...
								4f, // min asteroid radius 
								16f, // max asteroid radius
								"<el nombre va aqui>")); // null for default name
